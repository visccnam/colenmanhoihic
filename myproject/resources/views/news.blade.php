					...
					<div>
						<div id="news" class="body">
							<div class="sidebar">
								...
								<ul>
									<li>
										<a href="news.blade.php">2023 Bikini Contest Winners</a>
									</li>
									<li>
										<a href="news.blade.php">Top 10 Diving Spots</a>
									</li>
									<li>
										<a href="news.blade.php">Fishing ban to be implemented this year</a>
									</li>
									<li>
										<a href="news.blade.php">Lifeguard saves child from drowning</a>
									</li>
								</ul>
								<h3>Vaction Tips</h3>
								<ul>
									<li>
										<a href="news.blade.php">What to bring on the beach?</a>
									</li>
									<li>
										<a href="news.blade.php">Planning Fun Activities</a>
									</li>
									<li>
										<a href="news.blade.php">Diving Checklist</a>
									</li>
									<li>
										<a href="news.blade.php">First Aid</a>
									</li>
									<li>
										<a href="news.blade.php">How to Build a Sand Castle?</a>
									</li>
									<li>
										<a href="news.blade.php">Tanning Tips</a>
									</li>
								</ul>
							</div>
							<div>
		...
		<div id="footer">
			<div>
				<ul class="navigation">
					...
					<li>
						<a href="rooms.blade.php">Rooms</a>
					</li>
					<li>
						<a href="dives.blade.php">Dive Site</a>
					</li>
					<li>
						<a href="foods.blade.php">Food</a>
					</li>
					<li class="active">
